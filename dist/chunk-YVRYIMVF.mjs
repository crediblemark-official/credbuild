import {
  useAlignOptions
} from "./chunk-2VBHWBTC.mjs";
import {
  useHeadingOptions
} from "./chunk-QER4AZ5G.mjs";
import {
  useListOptions
} from "./chunk-LULMOTTE.mjs";
import {
  Bold,
  Code,
  ControlContext,
...
var AlignSelectLoaded = lazy(
  () => import("./loaded-74HNR5RM.mjs").then((m) => ({
...
var HeadingSelectLoaded = lazy2(
  () => import("./loaded-OJ4OUY43.mjs").then((m) => ({
...
var ListSelectLoaded = lazy3(
  () => import("./loaded-6EOZSQUC.mjs").then((m) => ({
