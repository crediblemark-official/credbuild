import {
  useAlignOptions
} from "./chunk-PODT62JK.mjs";
import {
  useHeadingOptions
} from "./chunk-GQ3A2HTO.mjs";
import {
  useListOptions
} from "./chunk-HLABALSA.mjs";
import {
  Bold,
  Code,
  ControlContext,
...
var AlignSelectLoaded = lazy(
  () => import("./loaded-RY34L2NI.mjs").then((m) => ({
...
var HeadingSelectLoaded = lazy2(
  () => import("./loaded-V6EASNRD.mjs").then((m) => ({
...
var ListSelectLoaded = lazy3(
  () => import("./loaded-D2GORL7D.mjs").then((m) => ({
