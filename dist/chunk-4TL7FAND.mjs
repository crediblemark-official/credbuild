...
var Editor = lazy(
  () => import("./Editor-LBIGDVH2.mjs").then((m) => ({
    default: m.Editor
  }))
);
var RichtextField = ({
...
function AutoField(props) {
  ...
  return /* @__PURE__ */ jsx20(fieldContextStore.Provider, { value: providerValue, children: /* @__PURE__ */ jsx20(AutoFieldPublicInternal, __spreadProps(__spreadValues({}, props), { id })) });
}
