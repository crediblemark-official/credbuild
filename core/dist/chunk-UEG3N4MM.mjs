import {
  useAlignOptions
} from "./chunk-BN2UXJLV.mjs";
import {
  useHeadingOptions
} from "./chunk-CVF37OBJ.mjs";
import {
  useListOptions
} from "./chunk-SDASUW2C.mjs";
import {
  Bold,
  Code,
  ControlContext,
...
var AlignSelectLoaded = lazy(
  () => import("./loaded-5AFSSDJC.mjs").then((m) => ({
...
var HeadingSelectLoaded = lazy2(
  () => import("./loaded-6Q5Y3NXO.mjs").then((m) => ({
...
var ListSelectLoaded = lazy3(
  () => import("./loaded-OUTBJZD6.mjs").then((m) => ({
