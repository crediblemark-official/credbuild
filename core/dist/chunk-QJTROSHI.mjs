  ...
  subscribeWithSelector2((set, get) => {
    ...
    return __spreadProps(__spreadValues({
      ...
      getComponentConfig: (type) => {
        var _a2;
        const { config, selectedItem: selectedItem2 } = get();
        const rootFields = ((_a2 = config.root) == null ? void 0 : _a2.fields) || defaultPageFields;
        return type && type !== "root" ? config.components[type] : selectedItem2 ? config.components[selectedItem2.type] : __spreadProps(__spreadValues({}, config.root), { fields: rootFields });
      },
      ...
      setUi: (ui, recordHistory) => set((s) => {
        ...
        const selectedItem2 = state.ui.itemSelector ? getItem(state.ui.itemSelector, state) : null;
        return __spreadProps(__spreadValues({}, s), { state, selectedItem: selectedItem2 });
      }),
