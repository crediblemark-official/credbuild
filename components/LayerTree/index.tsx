    ...
    >
      ...
      <div className={getClassNameLayer("inner")}>
        <button
          ...
          aria-expanded={containsZone ? shouldRenderChildren : undefined}
          onClick={() => {
            if (isSelected) {
...
export const LayerTree = memo(({
  ...
  // This prevents unnecessary cascading re-renders across the LayerTree's many nested consumer components
  // when the parent re-renders and the dragged state hasn't changed.
